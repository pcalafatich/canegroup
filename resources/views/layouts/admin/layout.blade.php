    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <div id="section-control" class="collapse {{Route::is('admin.about-section.*') || Route::is('admin.home-section.*') || Route::is('admin.menu-section')
                 ? 'show':'' }}" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ Route::is('admin.consulting-section.*')?'active':'' }}" href="{{ route('admin.consulting-section.index') }}">{{ $websiteLang->where('lang_key','consulting_section')->first()->custom_text }}</a>
                        <a class="collapse-item {{ Route::is('admin.desokupa-section.*')?'active':'' }}" href="{{ route('admin.desokupa-section.index') }}">{{ $websiteLang->where('lang_key','desokupa_section')->first()->custom_text }}</a>
                        <a class="collapse-item {{ Route::is('admin.realestate-section.*')?'active':'' }}" href="{{ route('admin.realestate-section.index') }}">{{ $websiteLang->where('lang_key','realestate_section')->first()->custom_text }}</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="home-section-2-pages" class="collapse {{ Route::is('admin.slider.index') || Route::is('admin.partner.index') || Route::is('admin.consultingservice.index') || Route::is('admin.testimonial.index') || Route::is('admin.overview.index') || Route::is('admin.service.index') ? 'show': '' }}" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ Route::is('admin.consultingservice.index')?'active':'' }}" href="{{ route('admin.consultingservice.index') }}">{{ $websiteLang->where('lang_key','consultingservice')->first()->custom_text }}</a>
                        <a class="collapse-item {{ Route::is('admin.desokupaservice.index')?'active':'' }}" href="{{ route('admin.desokupaservice.index') }}">{{ $websiteLang->where('lang_key','desokupaservice')->first()->custom_text }}</a>
                        <a class="collapse-item {{ Route::is('admin.realestateservice.index')?'active':'' }}" href="{{ route('admin.realestateservice.index') }}">{{ $websiteLang->where('lang_key','realestateservice')->first()->custom_text }}</a>
