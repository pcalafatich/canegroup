@php
    $topbar_contact=App\ContactUs::where('modelo','desokupa')->first();
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav m-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::is('desokupa.home') ? 'active' : '' }}" aria-current="page" href="{{ url('/') }}">{{ $home_menu->navbar }}</a>
            </li>
            @endif
            {{-- SOBRE NOSOTROS --}}
            @php
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  {{-- PAGINAS ESPECIALES --}}
                  @if ($customPages->where('modelo','desokupa')->count() !=0)
