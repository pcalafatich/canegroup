...
@section('title')
<title>{{ $websiteLang->where('lang_key','desokupa_section')->first()->custom_text }}</title>
@endsection
@section('admin-content')
    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">{{ $websiteLang->where('lang_key','desokupa_section')->first()->custom_text }}</h6>
        </div>
        ...
        <div class="card-body">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                {{-- VISION GENERAL --}}
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#overview" role="tab" aria-controls="profile" aria-selected="false">{{ $websiteLang->where('lang_key','overview')->first()->custom_text }}</a>
                  </li>
              ...
              <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade mt-5 show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    @php
