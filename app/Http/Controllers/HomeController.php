...
class HomeController extends Controller
{
    ...
    public function index(){
        $sliders =Slider::orderBy('id','asc')->where([['modelo','canevari'],['status',1]])->get();
        $aboutUs = About::first();
        ...
        return view('user.index',compact('sliders', 'aboutUs', 'blogs','seo_text','sections','currency','overviews','services','default_profile_image','testimonials','properties','agents','orders','feature_image','propertyTypes','cities','websiteLang','testimonial_bg','agent_bg','contact','contactSetting','service_bg'));
    }
