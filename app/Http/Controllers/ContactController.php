...
class ContactController extends Controller
{
    ...
    // VERIFICAR MODO DEMO
        ...
        $customMessages = [
            ...
            'lastname.required' => $valid_lang->where('lang_key','lastname')->first()->custom_text,
        ...
        $message=str_replace('{{lastname}}',$contact['lastname'],$message);
