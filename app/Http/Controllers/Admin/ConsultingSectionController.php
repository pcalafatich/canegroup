...
class ConsultingSectionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.consulting-section.index',compact('sections','websiteLang'));
    }
    ...
    public function updateFeatureSection(Request $request,$id){
        ...
        $homeSection=ConsultingSection::find($id);
        ...
        return redirect()->route('admin.consulting-section.index')->with($notification);
    }
